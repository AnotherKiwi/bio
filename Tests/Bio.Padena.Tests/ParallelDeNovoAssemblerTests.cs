...
namespace Bio.Padena.Tests
{
    ...
    public class ParallelDeNovoAssemblerTests
    {
        ...
        public void PalindromicAssembleTest()
        {
            ...
            Sequence testSequence = new Sequence(DnaAlphabet.Instance, testSeq);
            Sequence testSequence2 = new Sequence(DnaAlphabet.Instance, testSeq2);
            ...
            foreach (Sequence curTestSeq in new[] { testSequence, testSequence2 })
            {
                seqs.Clear();
                seqs.Add(curTestSeq);
                using (ParallelDeNovoAssembler assembler = new ParallelDeNovoAssembler())
